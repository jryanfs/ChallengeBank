...
namespace ChallengeBank.Api.Shared.Api;
...
public static class ApiMessages
{
    ...
    public const string ClientsServiceUnavailable = "O serviço de clientes está temporariamente indisponível. Tente novamente em instantes.";
    ...
    public static string FromError(Error error) =>
        error.Code switch
        {
            ...
            "Transfer.UserNotFound" => string.IsNullOrWhiteSpace(error.Message)
                ...
                : error.Message,
            "Transfer.ClientsServiceUnavailable" => ClientsServiceUnavailable,
